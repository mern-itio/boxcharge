...
export const technologyConfigs: Record<string, TechnologyPageConfig> = {
  "smart-routing": {
    eyebrow: "Technology",
    title: "Smart Routing",
    summary: "Performance-aware transaction routing across acquirers and corridors, designed to improve payment outcomes.",
    breadcrumbs: baseCrumbs("Smart Routing", "smart-routing"),
    overview:
      "Smart Routing analyzes acquirer performance, regional context, and merchant configuration to direct each transaction toward the route most likely to succeed. Routing decisions adapt to live performance signals across the BoxCharge acquiring network.",
    howItWorks: [
    ...
    securityBenefits: ["Routing decisions audited per transaction.", "Operates above tokenized payment data.", "No additional PAN exposure introduced by routing."],
    faq: [
      { q: "Can rules be customized?", a: "Yes. Routing rules can be configured to reflect cost, region, and performance preferences." },
      { q: "Does Smart Routing guarantee approvals?", a: "No. It is designed to improve routing efficiency and payment outcomes, but performance depends on acquirer and corridor conditions." },
    ],
  },
  "cascading-payments": {
    eyebrow: "Technology",
    title: "Cascading Payments",
    summary: "Automatic retry across alternative acquirers when an initial transaction attempt is not authorized.",
    breadcrumbs: baseCrumbs("Cascading Payments", "cascading-payments"),
    overview:
      "Cascading payments retry declined transactions through alternative acquirers configured for the merchant, helping reduce avoidable declines while respecting card network and acquirer rules.",
    howItWorks: [
    ...
    securityBenefits: ["Cascading respects 3DS context.", "Operates on tokenized references where available.", "Compliant with acquirer cascading rules."],
    faq: [
      { q: "Is cascading always triggered?", a: "No. Cascading runs only for eligible decline reasons and configured fallback paths." },
    ],
  },
  "fraud-prevention": {
    eyebrow: "Technology",
    title: "Fraud Prevention Layer",
    summary: "Rule-based fraud controls, velocity limits, and transaction monitoring designed to support secure payment operations.",
    ...
    securityBenefits: ["Operates pre-authorization where applicable.", "Aligned with partner compliance workflows.", "No PAN persistence beyond authorized flows."],
    faq: [
      { q: "Is the platform fraud-free?", a: "No platform can be fraud-free. The layer is designed to reduce risk through controls and monitoring." },
    ],
  },
  "3ds-authentication": {
    eyebrow: "Technology",
    title: "3DS Authentication",
    summary: "3D Secure authentication layer for supported card networks, integrated into the gateway flow.",
    ...
    securityBenefits: ["Cardholder authentication through issuer.", "Reduces certain CNP risk categories.", "Operates alongside tokenization."],
    faq: [
      { q: "Is 3DS always required?", a: "Requirements vary by region, network, and issuer." },
    ],
  },
  "tokenization": {
    eyebrow: "Technology",
    title: "Tokenization",
    summary: "Advanced card tokenization replaces sensitive card data with secure references for downstream use.",
    ...
    securityBenefits: ["Reduces PAN scope in merchant systems.", "Supports PCI DSS aligned operations.", "Enables tokenized cascading."],
    faq: [
      { q: "Where are tokens stored?", a: "Tokens are managed inside the BoxCharge platform with secure access controls." },
    ],
  },
  "pci-security": {
    eyebrow: "Technology",
    title: "PCI DSS Aligned Infrastructure",
    summary: "Infrastructure designed to support PCI DSS aligned operations and partner compliance workflows.",
    ...
    securityBenefits: ["Designed for PCI DSS aligned operations.", "Minimized PAN exposure through tokenization.", "Access and activity monitoring."],
    faq: [
      { q: "Is BoxCharge a card network?", a: "No. BoxCharge operates as a payment infrastructure provider working with acquiring and partner relationships." },
    ],
  },
};
